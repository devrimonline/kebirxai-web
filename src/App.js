        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="font-bold mb-4 sm:mb-6 leading-tight">
              <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent block text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl text-center sm:text-justify">
                Muhasebe Dünyası
              </span>
              <span className={`${isDark ? 'text-white' : 'text-gray-900'} block text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-center sm:text-justify mt-2`}>
                Yapay Zeka ile Buluşuyor...
              </span>
            </h1>
            
            <div className={`text-base sm:text-lg md:text-xl lg:text-2xl mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-600'} text-center sm:text-justify`}>
