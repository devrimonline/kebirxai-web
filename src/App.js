        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-3">
              <img src="/2kebirxweb-fil.png" alt="KebirX Logo" className="w-10 h-10 object-contain" />
      ...
      <section className="relative z-10 pt-16 pb-20 sm:pt-24 sm:pb-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            {/* Search Bar */}
            <form action="https://forum.kebirxai.tr/search" target="_blank" method="get" className="max-w-2xl mx-auto">
              <div className={`relative backdrop-blur-md ${isDark ? 'bg-gray-800/50' : 'bg-white/50'} rounded-2xl border ${isDark ? 'border-gray-700' : 'border-gray-200'} shadow-xl`}>
                ...
                />
                <button type="submit" className="absolute right-3 top-1/2 transform -translate-y-1/2 p-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center space-x-3 mb-4">
              <img src="/2kebirxweb-fil.png" alt="KebirX Logo" className="w-8 h-8 object-contain" />
